...
class Brain:
    def __init__(self):
        ...
        self.control_ai = Ai(api_client=self.api_client, prompt=CONTROL_PROMPT, keep_history=False)
        self.chat_ai = Ai(api_client=self.api_client, prompt=CHAT_PROMPT, keep_history=True)
